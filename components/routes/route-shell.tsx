    ...
    <main className="grain min-h-screen px-6 py-8 md:px-10 md:py-10">
      <div className="mx-auto max-w-5xl space-y-8">
        <div className="flex items-center justify-between rounded-full border border-line bg-surface px-4 py-3 shadow-[0_12px_40px_rgba(31,27,23,0.08)] backdrop-blur">
          ...
          <Link
            href="/"
            className="rounded-full border border-line bg-white/70 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-foreground transition-transform duration-200 hover:-translate-y-0.5"
          >
            Back home
          </Link>
        </div>
        ...
        <section className="rounded-[2rem] border border-line bg-surface p-7 shadow-[0_20px_60px_rgba(31,27,23,0.12)]">
          ...
          <div className="mt-8 rounded-[1.5rem] border border-line bg-white/80 p-5">
